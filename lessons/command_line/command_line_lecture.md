...
> Question: Directory should now be included in the path of the terminal(in each command line)
...
command line created a file within our test directory, output is blank b/c action was executed
...
> What changed? converted it into kilo bytes
